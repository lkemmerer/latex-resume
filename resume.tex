...
\section{Experience}
\cventry{Sept 2016 to present}{Software Engineer/Team Lead}{ShiftWise}{Portland, OR}{}{As part of the platform team, I helped create the infrastructure for an event-driven application. It relies on AWS SQS/SNS and Akka's actor system to process high volumes of data and feed into our reporting team's data lake. In February I was made team lead. In addition to existing duties, I facilitate communication with management, other teams, and stakeholders and advocate for my team and their needs.\newline{}\newline{}Recently, I've been supporting another platform team as they convert our Windows-based .NET microservices to Linux and AWS tools.}
