...
\begin{document}
  ...
  \name{LAURIE KEMMERER\\[10pt]} % the \\[10pt] adds a blank line after name
  ...
  \begin{resume}
    ...
    \begin{ncolumn}{2}
	    ...
	    \title{l} \itshape Software Engineer & \hfill \dates{r}2009-Spring 2010 \\
      \title{l} \itshape Q.A. Engineer & \hfill \dates{r}Spring 2007-2008 \\
    \end{ncolumn}
    \begin{itemize} \itemsep -2pt
